...
class AdminTenantManagementTest extends TestCase
{
    ...
    public function test_livewire_tenant_index_creates_tenant_from_modal(): void
    {
        ...
        Livewire::actingAs($superAdmin)
            ...
            ->assertSee('New tenant owners receive their login first.')
    ...
    public function test_livewire_tenant_index_edits_tenant_from_modal(): void
    {
        ...
        Livewire::actingAs($superAdmin)
            ...
            ->call('edit', $tenant->id)
            ->assertSet('showFormModal', true)
            ->assertSee('Owner 2FA readiness')
            ->assertSee('Needs setup')
            ->assertSee('The owner login exists, but two-factor authentication is not confirmed yet.')
