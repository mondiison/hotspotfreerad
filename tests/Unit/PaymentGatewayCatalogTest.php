...
class PaymentGatewayCatalogTest extends TestCase
{
    ...
    {
        return [
            'flutterwave' => [PaymentGatewayCatalog::FLUTTERWAVE, ['*.flutterwave.com', '*.ravepay.co', '*.dev-flutterwave.com']],
            ...
            'null falls back to flutterwave' => [null, ['*.flutterwave.com', '*.ravepay.co', '*.dev-flutterwave.com']],
            'unknown key falls back to flutterwave' => ['not-a-real-gateway', ['*.flutterwave.com', '*.ravepay.co', '*.dev-flutterwave.com']],
        ];
    }
